...
export const courseData = [
    ...
    {id:4, icons: logo, title: 'Rus Tili', btn:'TOP', name1:'Fozilhon Buzrukhojayev', name2: 'Umarkhon Buzrukhojayev', title2:'Batafsil' },
    {id:5, icons: logo, title: 'Arab Tili', btn:'TOP', name1:'Fozilhon Buzrukhojayev', name2: 'Umarkhon Buzrukhojayev', title2:'Batafsil' },
    {id:6, icons: logo, title: 'Matematika', btn:'TOP', name1:'Fozilhon Buzrukhojayev', name2: 'Umarkhon Buzrukhojayev', title2:'Batafsil' },
]